  ...
  const tableData = [
    {
      ...
      description:
        'Observes expressiveness in eye area, showing interest and emotional engagement.',
      percentage: 83,
      color: 'bg-[#4CAF50]',
      explain:
        'Clear eye expressivity, indicating strong emotional engagement.',
    },
    {
      subskill: 'Lower Face Expressivity',
      description:
        'Measures mouth expressiveness, reflecting emotional responsiveness.',
      percentage: 75,
      color: 'bg-[#66BB6A]',
      explain:
        'Good lower facial expressivity, showing responsiveness to social interactions.',
    },
  ];
  const tableData1 = [
    {
      ...
      description:
        'Shows variety in emotions displayed, indicating emotional adaptability and health',
      percentage: 80,
      color: 'bg-[#4CAF50]',
      explain:
        'Displays a broad range of emotions, reflecting healthy emotional adaptability.',
    },
    {
      subskill: 'Emotion Mirroring',
      description:
        "Measures ability to reflect others' emotions, showing empathy and social awareness.",
      percentage: 78,
      color: 'bg-[#66BB6A]',
      explain:
        'Mirrors emotions effectively, indicating social awareness and empathy.',
    },
  ];
    ...
    <div className="pdf-image flex flex-col font-raleway items-center p-8 bg-white min-h-screen">
      <div className="pdf-page bg-white p-8 shadow-md rounded-md flex justify-center items-center w-[210mm] h-[297mm] relative">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="w-full border rounded-3xl p-4 border-[#CDAAE0] font-raleway">
            <h3 className="text-center text-sm font-bold mb-5">
              Emotional and Mirroring Response
            </h3>
            <table className="w-full border-collapse">
              {/* Table Header */}
              <thead>
