  ...
  const tableData = [
    {
      ...
      description:
        'Tracks responsiveness to her name, indicating social awareness.',
      percentage: 82,
      color: 'bg-[#4CAF50]',
      explain:
        'Responds promptly, indicating good social awareness and engagement.',
    },
    {
      subskill: 'Attention to Speech',
      description:
        'Measures focus on speech, showing interest in auditory communication.',
      percentage: 76,
      color: 'bg-[#66BB6A]',
    ...
    },
    {
      ...
      description:
        'Frequency of vocal sounds, showing comfort with vocal expression.',
      percentage: 73,
      color: 'bg-[#66BB6A]',
      explain:
        'Engages vocally, showing comfort and engagement in verbal interaction.',
    },
    {
      subskill: 'Vocalization Variety',
      description:
        'Range of vocal sounds, indicating language development flexibility.',
      percentage: 78,
      color: 'bg-[#4CAF50]',
      explain:
        'Healthy variety of sounds, showing flexibility in vocal expression and early language development.',
    },
  ];
  ...
  const tableData1 = [
    {
      ...
      color: 'bg-[#4CAF50]',
      explain:
        'Shows controlled head movements, reflecting focused attentiveness.',
    },
    {
      subskill: 'Body Movement',
      description:
        'Measures body movement levels, indicating engagement or restlessness.',
      percentage: 75,
      color: 'bg-[#66BB6A]',
      explain:
        'Healthy body movement levels, indicating appropriate engagement.',
    },
    {
      subskill: 'No Repetitive Movement',
      description:
        'Absence of repetitive behaviors typically seen in neurotypical development.',
      percentage: 85,
      color: 'bg-[#4CAF50]',
      explain:
        'No repetitive movements observed, consistent with typical development.',
    },
    {
      subskill: 'Movement Control',
      description:
        'Assesses ability to regulate movements, indicating self-regulation and motor control.',
      percentage: 77,
      color: 'bg-[#66BB6A]',
      ...
      <div className="pdf-page bg-white p-8 shadow-md rounded-md flex justify-center items-center w-[210mm] h-[297mm] relative">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="w-full border rounded-3xl p-4 border-[#CDAAE0] font-raleway">
            <h3 className="text-center text-sm font-bold mb-5">
              {' '}
                ...
                {tableData1.map((row, index) => (
                  <tr key={index} className="border-b border-gray-300">
                    ...
                    <td className="p-4 text-[10px] text-gray-800 w-[35%] font-semibold border-r border-gray-300">
                      {row.subskill}
                      <br />
                      <span className="font-normal text-gray-600 text-[8px]">
                        {row.description}
                      </span>
                    </td>
                    {/* Performance */}
