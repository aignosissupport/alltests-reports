        ...
        <div className="pdf-page bg-white p-8 shadow-md rounded-md w-[210mm] h-[297mm]">
          ...
          >
            ...
            <div style={{ textAlign: 'justify' }}>
              The INCLEN-ASD tool has been developed for identification of
              Autism Spectrum Disorder. This has been further modified by AIIMS,
              New Delhi.
              <br />
              <br />
              <center>
              ...
              <br />
              {INCLENscore === '1' ||
              (INCLENscore === '0' && INCLEN_B4.charAt(0) === '1') ? (
                <>
                  The scores of INDT-ASD were indicating that the child has
