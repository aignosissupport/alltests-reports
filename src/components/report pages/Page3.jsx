  ...
  const tableData = [
    {
      ...
      color: 'bg-[#4CAF50]',
      explain:
        'Shows strong social preference, suggesting healthy social engagement.',
    },
    {
      subskill: 'Eye Contact',
      description:
        'Tracks frequency and duration of eye contact, showing comfort with social interaction.',
      percentage: 100 - testData.eye_contact_error,
      color: 'bg-[#66BB6A]',
      explain:
        'Maintains good eye contact, indicating responsiveness in social interactions.',
    },
    {
      ...
      color: 'bg-[#FFC107]',
      explain:
        'Easily engages in joint attention, suggesting strong foundational communication skills.',
    },
    {
      subskill: 'Gaze Hold',
      description:
        'Indicates duration of gaze on an object, reflecting attentiveness and sustained focus.',
      percentage: testData.gaze_holds,
      color: 'bg-[#66BB6A]',
      explain:
        'Demonstrates sustained attention, indicating interest in surroundings.',
    },
    {
      subskill: 'Gaze Speed',
      description:
        'Assesses the speed of gaze shifts, which is associated with attentiveness and visual processing.',
      percentage: testData.gaze_speed,
      color: 'bg-[#FFC107]',
      explain:
        'Displays typical gaze speed, reflecting balanced visual responsiveness.',
    },
    {
      subskill: 'Attention Shift Frequency',
      description:
        'Frequency of attention shifts, suggesting cognitive flexibility and engagement.',
      percentage: testData.saccades,
      color: 'bg-[#66BB6A]',
      explain:
        'Balanced shift frequency, suggesting natural curiosity and engagement.',
    },
    {
      subskill: 'Gaze Stability',
      description:
        'Measures spread of gaze across different areas, showing exploration and focus distribution.',
      percentage: testData.gaze_dispersion,
      color: 'bg-[#4CAF50]',
      explain:
        'Distributes gaze well, indicating healthy exploration of surroundings.',
    },
    {
      subskill: 'Focal Points',
      description:
        'Measures preference for gaze points, such as faces and social interactions.',
      percentage: testData.focal_IOU,
      color: 'bg-[#66BB6A]',
      explain:
        'Focuses on multiple points, showing curiosity and attention to detail.',
    },
    {
      subskill: 'Screen Focus',
      description:
        'Measures screen fixation to typical engagement levels, assessing attentional stability.',
      percentage: testData.screen_focus,
      color: 'bg-[#66BB6A]',
      explain:
        'Maintains attention on visual tasks, indicating good focus abilities.',
    },
    {
      subskill: 'Object Tracking',
      description:
        'Observes ability to follow moving objects for visual-motor coordination.',
      percentage: 100 - testData.object_tracking_error,
      color: 'bg-[#FFC107]',
      explain:
        'Tracks objects smoothly, indicating typical visual-motor coordination skills.',
    },
  ];
          ...
          <table className="w-full border-collapse">
            ...
            <thead>
              <tr className="text-left">
                <th className="p-2 text-[12px] border-r font-lg border-b border-gray-300 text-center">
                  Feature
                </th>
                <th className="p-2 text-[12px] border-r font-lg border-b border-gray-300 text-center">
                  Percentile
                </th>
                <th className="p-2 text-[12px] font-lg border-b border-gray-300 text-center">
                  Explanation
                </th>
              </tr>
            </thead>
              ...
              {tableData.map((row, index) => (
                <tr key={index} className="border-b border-gray-300 ]">
                  ...
                  <td className="p-2.5 text-[10px] text-gray-800 w-[35%] font-semibold border-r border-gray-300">
                    {row.subskill}
                    <br />
                    <span className="font-normal text-gray-600 text-[12px]">
                      {row.description}
                    </span>
                  </td>
                  {/* Performance */}
                  <td className="py-6 px-6 text-center w-[30%] border-r border-gray-300">
                    <div className="w-[80%] h-5 mx-auto rounded-full bg-gray-200">
                      <div
                        className={`flex justify-end items-center h-full rounded-full ${row.color}`}
                  ...
                  {/* Results */}
                  <td className="py-4 px-4 text-[8px] text-gray-800 w-[35%]">
                    {row.explain}
                  </td>
                </tr>
              ))}
