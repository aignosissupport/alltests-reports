        ...
        <div className="pdf-page bg-white p-8 shadow-md rounded-md w-[210mm] h-[297mm]">
          ...
          >
            ...
            <div style={{ textAlign: 'justify' }}>
              The Modified Checklist for Autism in Toddlers, Revised (MCHAT-R)
              is a standardized screening tool designed to assess behavioral
              development in toddlers aged 16-30 months. This 20-question
              screener evaluates various aspects of a child's behavior,
              providing insight into their developmental progress.
              <br /> <br /> <br /> <br />
              The caregiver of {name} completed the MCHAT-R, and based on the
              results, the child scored a total of {mchatScore}. This score
              indicates that {name} falls within the {MCHATinterpretation} risk
              range for Autism.
              ...
              These results will inform discussions with {name}'s healthcare
              provider, ensuring timely and appropriate support for their
              developmental needs.
              <br />
              <br />
            </div>
