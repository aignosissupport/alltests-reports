    ...
    <>
      ...
      <div className="pdf-image flex flex-col font-manrope items-center p-8 bg-white min-h-screen">
        <div className="pdf-page bg-white p-8 shadow-md rounded-md w-[210mm] h-[297mm]">
          ...
          >
            ...
            <div style={{ textAlign: 'justify' }}>
              ...
              (CARS-2), which is a 15- item behavioral rating scale. It is
              designed as a screening tool to identify children with autism and
              help identify possible signs of autism (or autism spectrum
              disorder). The CARS-2 ratings are comprised of behavioral
              observations, parental reports, and a review of relevant records.
        ...
        <p style={{textAlign:"left"}}>Interpretation: <span id="carsInterpretationmessage">{carsInterpretation}</span></p> */}
            ...
            textAlign:"justify"}}> */}
            <p>
              The scores of CARS were indicating that the child has{' '}
              {carsInterpretation} Spectrum Disorder.
            </p>
            {/* </div> */}
            {/* <h2 style={{textAlign:"left"}}>ISAA Score: <span id="isaascore">{TOT_CARS} </span></h2>
        <p style={{textAlign:"left"}}>Interpretation: <span id="carsInterpretationmessage">{carsInterpretation}</span></p> */}
