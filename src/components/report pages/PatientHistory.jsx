...
const ISAA = () => {
  ...
  const patientData = {
    ...
    nicu_final:
      formatSentence(
        getURLParameter('c5_1') || 'N/A',
        getURLParameter('c5_2') || 'N/A'
      ) || 'N/A',
    ...
    family_medical_history:
      formatMedHistory(
        getURLParameter('b10_1') || 'N/A',
        getURLParameter('b10_2') || 'N/A'
      ) || 'N/A',
  };
    ...
    <div className="pdf-image flex flex-col font-manrope items-center p-8 bg-white min-h-screen relative">
      <div className="pdf-page bg-white p-8 shadow-md rounded-md w-[210mm] h-[297mm] relative">
        ...
        <h2 className="text-2xl font-bold text-purple-800 mt-6">
          Patient <span className="text-black">History</span>
        </h2>
        ...
        <table className="w-full mx-auto mt text-[12px] border-collapse">
          <tbody>
            ...
            <tr>
              ...
              <td className="text-left border px-4 py-2">
                Test location: {patientData.test_location}
              </td>
            </tr>
            <tr>
              <td className="text-left border px-4 py-2">
                Assessor: {patientData.assessor}
              </td>
              <td className="text-left border px-4 py-2">
                Informant: {patientData.informant}
              </td>
            </tr>
            <tr>
              <th className="text-center underline py-5" colSpan={3}>
            ...
            <tr>
              <td className="text-left border px-4 py-2">
                Social Smile: {patientData.social_smile}
              </td>
              <td className="text-left border px-4 py-2">
                Head Control: {patientData.head_control}
              </td>
              <td className="text-left border px-4 py-2">
                Sitting: {patientData.sitting}
              </td>
            </tr>
            <tr>
              <td className="text-left border px-4 py-2">
              ...
              <td className="text-left border px-4 py-2">
                Babbling: {patientData.babbling}
              </td>
            </tr>
            <tr>
              <td className="text-left border px-4 py-2">
                One Word (meaningful): {patientData.one_word}
              </td>
              <td className="text-left border px-4 py-2">
                Speech: {patientData.speech}
              </td>
              <td className="text-left border px-4 py-2">
            ...
            <tr>
              <td className="text-left border px-4 py-2">
                Seizures: {patientData.seizures}
              </td>
              <td className="text-left border px-4 py-2">
                Feeding Difficulties: {patientData.feeding_diff}
              </td>
              <td className="text-left border px-4 py-2">
                Abnormal Movements: {patientData.abnormal_movement}
              </td>
            </tr>
            <tr>
              <td className="text-left border px-4 py-2">
                Vision Difficulties: {patientData.vision_diff}
              </td>
              <td className="text-left border px-4 py-2">
                Hearing Difficulties: {patientData.hearing_diff}
              </td>
              <td className="text-left border px-4 py-2">
                Therapy Received: {patientData.therapy_received}
              </td>
            </tr>
            <tr>
              <th className="text-center underline py-5" colSpan={3}>
            ...
            <tr>
              <td className="text-left border px-4 py-2">
                Place of Delivery: {patientData.pod}
              </td>
              <td className="text-left border px-4 py-2">
                Gestational Age: {patientData.gest_age}
              </td>
              <td className="text-left border px-4 py-2">
                Birth Order: {patientData.birth_order}
              </td>
            </tr>
            <tr>
              <td className="text-left border px-4 py-2">
                Delivery Type: {patientData.delivery_type}
              </td>
              <td className="text-left border px-4 py-2">
                Birth Cry: {patientData.birth_cry}
              </td>
              <td className="text-left border px-4 py-2">
                NICU Stay: {patientData.nicu_final}
              </td>
            </tr>
            <tr>
              <td className="text-left border px-4 py-2">
                Birth Weight: {patientData.birth_weight}
              </td>
              <td className="text-left border px-4 py-2">
                Congenital Malformations: {patientData.atypical_body}
              </td>
            </tr>
            <tr>
              <th className="text-center underline py-5" colSpan={3}>
            ...
            <tr>
              ...
              <td className="text-left border px-4 py-2">
                Poor Weight Gain: {patientData.weight_gain}
              </td>
              <td className="text-left border px-4 py-2">
                Bleeding in Pregnancy: {patientData.bleeding}
              </td>
            </tr>
            <tr>
              <td className="text-left border px-4 py-2">
              ...
              <td className="text-left border px-4 py-2">
                Infection: {patientData.infection}
              </td>
              <td className="text-left border px-4 py-2">
                Use of Harmful Medication: {patientData.hyperthyroidism}
              </td>
            </tr>
            <tr>
              <td className="text-left border px-4 py-2">
                Trauma: {patientData.weight_gain}
              </td>
            </tr>
            <tr>
              <th className="text-center underline py-5" colSpan={3}>
            ...
            <tr>
              <td className="text-left border px-4 py-2">
                Marriage in Family Relation:{' '}
                {patientData.marriage_in_family_relation}
              </td>
              <td className="text-left border px-4 py-2">
                Family Type: {patientData.family_type}
              </td>
              <td className="text-left border px-4 py-2">
                Medical History: {patientData.family_medical_history}
              </td>
            </tr>
          </tbody>
        </table>
